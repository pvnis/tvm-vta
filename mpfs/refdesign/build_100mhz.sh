#!/bin/bash
# Build the 100 MHz VTA design and CHECK it, rather than trusting Libero's exit code.
#
...
step "build (synth, P&R, timing)" vta_build.tcl build100.log
step "programming data"           vta_prog.tcl  prog100.log
