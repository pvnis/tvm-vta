#!/bin/bash
# Full clean build of the 100 MHz VTA design, from a regenerated base.
#
...
step "integrate VTA at 100 MHz"       vta_integrate.tcl                       integrate100.log
exec ./build_100mhz.sh
